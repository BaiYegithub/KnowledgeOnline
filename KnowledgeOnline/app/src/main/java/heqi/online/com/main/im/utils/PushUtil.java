...
import heqi.online.com.main.im.event.MessageEvent;
...
public class PushUtil implements Observer {
    ...
    private void PushNotify(TIMMessage msg){
        ...
        NotificationManager mNotificationManager = (NotificationManager) MyApplication.getAppContext().getSystemService(MyApplication.getAppContext().NOTIFICATION_SERVICE);
        ...
        PendingIntent intent = PendingIntent.getActivity(MyApplication.getAppContext(), 0,
...
//                .setNumber(++pushNum) //设置通知集合的数量
    ...
    public void reset(){
        NotificationManager notificationManager = (NotificationManager)MyApplication.getAppContext().getSystemService(MyApplication.getAppContext().NOTIFICATION_SERVICE);
