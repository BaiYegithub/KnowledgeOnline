...
import heqi.online.com.main.im.model.CustomMessage;
import heqi.online.com.main.im.model.FileMessage;
import heqi.online.com.main.im.model.ImageMessage;
import heqi.online.com.main.im.model.Message;
import heqi.online.com.main.im.model.MessageFactory;
import heqi.online.com.main.im.model.TextMessage;
import heqi.online.com.main.im.model.VideoMessage;
import heqi.online.com.main.im.model.VoiceMessage;
import heqi.online.com.main.im.presenter.ChatPresenter;
import heqi.online.com.main.im.ui.ChatInput;
import heqi.online.com.main.im.ui.ImagePreviewActivity;
import heqi.online.com.main.im.ui.TemplateTitle;
import heqi.online.com.main.im.ui.VoiceSendingView;
import heqi.online.com.main.im.utils.FileUtil;
import heqi.online.com.main.im.utils.MediaUtil;
import heqi.online.com.main.im.utils.RecorderUtil;
import heqi.online.com.main.im.viewfeatures.ChatView;
...
public class ChatActivity extends FragmentActivity implements ChatView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // StatusBarCompat.setStatusBarColor(this, Color.parseColor("#ffffff"), true);
        ...
        adapter = new ChatAdapter(this, R.layout.item_message, messageList, identify);
            ...
            case Group:
                ...
                title.setMoreImgAction(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                      ...
                      /*  Intent intent = new Intent(ChatActivity.this, MsgClassDetailActivity.class);
                        intent.putExtra("classId", identify);
                ...
                TIMValueCallBack<List<TIMGroupBaseInfo>> cb = new TIMValueCallBack<List<TIMGroupBaseInfo>>() {
                    ...
                    public void onSuccess(List<TIMGroupBaseInfo> timGroupInfos) {//参数返回各群组基本信息
                        ...
                        for (TIMGroupBaseInfo info : timGroupInfos) {
                            Log.i(TAG, "group id: " + info.getGroupId() +
                                    " group name: " + info.getGroupName() +
                                    " group type: " + info.getGroupType());
                            if (identify.equals(info.getGroupId())) {
                                title.setTitleText(info.getGroupName());
                            }
