...
import heqi.online.com.main.im.ui.GroupManageMessageActivity;
...
public class GroupManageConversation extends Conversation {
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return MyApplication.getAppContext().getResources().getString(R.string.summary_me)+
                            MyApplication.getAppContext().getResources().getString(R.string.summary_group_invite)+
                            to+
                            MyApplication.getAppContext().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                MyApplication.getAppContext().getResources().getString(R.string.summary_group_invite)+
                                MyApplication.getAppContext().getResources().getString(R.string.summary_me)+
                                MyApplication.getAppContext().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                MyApplication.getAppContext().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return MyApplication.getAppContext().getResources().getString(R.string.summary_me)+
                            MyApplication.getAppContext().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+MyApplication.getAppContext().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return MyApplication.getAppContext().getString(R.string.conversation_system_group);
    }
