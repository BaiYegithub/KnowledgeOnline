...
public class FileMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        tv.setTextColor(MyApplication.getAppContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        ...
        return MyApplication.getAppContext().getString(R.string.summary_file);
    }
