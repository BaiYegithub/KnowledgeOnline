package heqi.online.com.main.im.utils;
...
public class TimeUtil {
    ...
    public static String getChatTimeStr(long timeStamp){
        ...
        if (calendar.before(inputTime)){
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm");
            return MyApplication.getAppContext().getResources().getString(R.string.time_yesterday)+" "+sdf.format(currenTimeZone);
        }else{
            calendar.set(Calendar.DAY_OF_MONTH, 1);
            calendar.set(Calendar.MONTH, Calendar.JANUARY);
            if (calendar.before(inputTime)){
                SimpleDateFormat sdf = new SimpleDateFormat("M"+MyApplication.getAppContext().getResources().getString(R.string.time_month)+"d"+MyApplication.getAppContext().getResources().getString(R.string.time_day)+" HH:mm");
                return sdf.format(currenTimeZone);
            }else{
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy"+MyApplication.getAppContext().getResources().getString(R.string.time_year)+"MM"+MyApplication.getAppContext().getResources().getString(R.string.time_month)+"dd"+MyApplication.getAppContext().getResources().getString(R.string.time_day)+" HH:mm");
                return sdf.format(currenTimeZone);
            }
