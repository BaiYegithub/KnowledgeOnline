...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        ImageView voiceIcon = new ImageView(MyApplication.getAppContext());
        ...
        tv.setTextColor(MyApplication.getAppContext().getResources().getColor(isSelf() ? R.color.white : R.color.firstBlack));
    ...
    public String getSummary() {
        ...
        return MyApplication.getAppContext().getString(R.string.summary_voice);
    }
