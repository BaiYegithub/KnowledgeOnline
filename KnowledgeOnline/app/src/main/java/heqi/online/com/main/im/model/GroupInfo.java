...
import heqi.online.com.main.im.event.GroupEvent;
import heqi.online.com.main.im.event.RefreshEvent;
...
public class GroupInfo implements Observer {
    ...
    public static String getTypeName(String type){
        if (type.equals(GroupInfo.publicGroup)){
            return MyApplication.getAppContext().getString(R.string.public_group);
        }else if (type.equals(GroupInfo.privateGroup)){
            return MyApplication.getAppContext().getString(R.string.discuss_group);
        }else if (type.equals(GroupInfo.chatRoom)){
            return MyApplication.getAppContext().getString(R.string.chatroom);
        }
        return "";
    }
